...
public abstract class LifecycleUtils {
    ...
    public static void init(Object o) throws RuntimeException {
        if (o instanceof Initializable) {
            init((Initializable) o);
        }
    }

    public static void init(Initializable initializable) throws RuntimeException {
        initializable.init();
    }
     ...
     * @throws RuntimeException if unable to initialize one or more instances.
     * @since 0.9
     */
    public static void init(Collection c) throws RuntimeException {
        if (c == null || c.isEmpty()) {
            return;
        }
        for (Object o : c) {
