    ...
    implements ECPublicKey, ru.mipt.cybersecurity.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private ru.mipt.cybersecurity.math.ec.ECPoint q;
        ...
        ru.mipt.cybersecurity.jce.spec.ECPublicKeySpec     spec)
    {
        ...
        else
        {
            if (q.getCurve() == null)
            {
                ru.mipt.cybersecurity.jce.spec.ECParameterSpec s = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    public ru.mipt.cybersecurity.math.ec.ECPoint engineGetQ()
    {
        return q;
    }
