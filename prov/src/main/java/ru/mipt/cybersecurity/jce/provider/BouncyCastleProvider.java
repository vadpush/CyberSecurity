...
import ru.mipt.cybersecurity.jcajce.provider.symmetric.util.ClassUtil;
...
import ru.mipt.cybersecurity.pqc.jcajce.provider.mceliece.McElieceCCA2KeyFactorySpi;
import ru.mipt.cybersecurity.pqc.jcajce.provider.mceliece.McElieceKeyFactorySpi;
 ...
 * <pre>
 * <code>
 *    security.provider.&lt;n&gt;=ru.mipt.cybersecurity.jce.provider.BouncyCastleProvider
 * </code>
 * </pre>
    ...
    implements ConfigurableProvider
{
     ...
     */
    private static final String SYMMETRIC_PACKAGE = "ru.mipt.cybersecurity.jcajce.provider.symmetric.";
     ...
     */
    private static final String ASYMMETRIC_PACKAGE = "ru.mipt.cybersecurity.jcajce.provider.asymmetric.";
     ...
     */
    private static final String DIGEST_PACKAGE = "ru.mipt.cybersecurity.jcajce.provider.digest.";
     ...
     */
    private static final String KEYSTORE_PACKAGE = "ru.mipt.cybersecurity.jcajce.provider.keystore.";
     ...
     */
    private static final String SECURE_RANDOM_PACKAGE = "ru.mipt.cybersecurity.jcajce.provider.drbg.";
    ...
    private void setup()
    {
        ...
        // X509Store
        //
        put("X509Store.CERTIFICATE/COLLECTION", "ru.mipt.cybersecurity.jce.provider.X509StoreCertCollection");
        put("X509Store.ATTRIBUTECERTIFICATE/COLLECTION", "ru.mipt.cybersecurity.jce.provider.X509StoreAttrCertCollection");
        put("X509Store.CRL/COLLECTION", "ru.mipt.cybersecurity.jce.provider.X509StoreCRLCollection");
        put("X509Store.CERTIFICATEPAIR/COLLECTION", "ru.mipt.cybersecurity.jce.provider.X509StoreCertPairCollection");

        put("X509Store.CERTIFICATE/LDAP", "ru.mipt.cybersecurity.jce.provider.X509StoreLDAPCerts");
        put("X509Store.CRL/LDAP", "ru.mipt.cybersecurity.jce.provider.X509StoreLDAPCRLs");
        put("X509Store.ATTRIBUTECERTIFICATE/LDAP", "ru.mipt.cybersecurity.jce.provider.X509StoreLDAPAttrCerts");
        put("X509Store.CERTIFICATEPAIR/LDAP", "ru.mipt.cybersecurity.jce.provider.X509StoreLDAPCertPairs");
        
        //
        // X509StreamParser
        //
        put("X509StreamParser.CERTIFICATE", "ru.mipt.cybersecurity.jce.provider.X509CertParser");
        put("X509StreamParser.ATTRIBUTECERTIFICATE", "ru.mipt.cybersecurity.jce.provider.X509AttrCertParser");
        put("X509StreamParser.CRL", "ru.mipt.cybersecurity.jce.provider.X509CRLParser");
        put("X509StreamParser.CERTIFICATEPAIR", "ru.mipt.cybersecurity.jce.provider.X509CertPairParser");

        //
        // cipher engines
        //
        put("Cipher.BROKENPBEWITHMD5ANDDES", "ru.mipt.cybersecurity.jce.provider.BrokenJCEBlockCipher$BrokePBEWithMD5AndDES");

        put("Cipher.BROKENPBEWITHSHA1ANDDES", "ru.mipt.cybersecurity.jce.provider.BrokenJCEBlockCipher$BrokePBEWithSHA1AndDES");


        put("Cipher.OLDPBEWITHSHAANDTWOFISH-CBC", "ru.mipt.cybersecurity.jce.provider.BrokenJCEBlockCipher$OldPBEWithSHAAndTwofish");

        // Certification Path API
        put("CertPathValidator.RFC3281", "ru.mipt.cybersecurity.jce.provider.PKIXAttrCertPathValidatorSpi");
        put("CertPathBuilder.RFC3281", "ru.mipt.cybersecurity.jce.provider.PKIXAttrCertPathBuilderSpi");
        put("CertPathValidator.RFC3280", "ru.mipt.cybersecurity.jce.provider.PKIXCertPathValidatorSpi");
        put("CertPathBuilder.RFC3280", "ru.mipt.cybersecurity.jce.provider.PKIXCertPathBuilderSpi");
        put("CertPathValidator.PKIX", "ru.mipt.cybersecurity.jce.provider.PKIXCertPathValidatorSpi");
        put("CertPathBuilder.PKIX", "ru.mipt.cybersecurity.jce.provider.PKIXCertPathBuilderSpi");
        put("CertStore.Collection", "ru.mipt.cybersecurity.jce.provider.CertStoreCollectionSpi");
        put("CertStore.LDAP", "ru.mipt.cybersecurity.jce.provider.X509LDAPCertStoreSpi");
        put("CertStore.Multi", "ru.mipt.cybersecurity.jce.provider.MultiCertStoreSpi");
