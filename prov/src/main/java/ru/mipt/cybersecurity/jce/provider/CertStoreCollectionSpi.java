...
public class CertStoreCollectionSpi extends CertStoreSpi
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        {
            throw new InvalidAlgorithmParameterException("ru.mipt.cybersecurity.jce.provider.CertStoreCollectionSpi: parameter must be a CollectionCertStoreParameters object\n" +  params.toString());
        }
