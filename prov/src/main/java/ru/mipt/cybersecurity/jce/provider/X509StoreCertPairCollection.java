 ...
 * {@link ru.mipt.cybersecurity.x509.X509Store} SPI implementation for certificate
 * pairs.
 *
 * @see ru.mipt.cybersecurity.x509.X509Store
 * @see ru.mipt.cybersecurity.x509.X509CertificatePair
 */
public class X509StoreCertPairCollection extends X509StoreSpi
{
     ...
     * {@link ru.mipt.cybersecurity.x509.X509CertificatePair}s. The selector must be
     * a {@link ru.mipt.cybersecurity.x509.X509CertPairStoreSelector} to select
     * certificate pairs.
     * </p>
