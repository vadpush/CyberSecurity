...
import ru.mipt.cybersecurity.x509.X509StreamParserSpi;
import ru.mipt.cybersecurity.x509.util.StreamParsingException;
    ...
    extends X509StreamParserSpi
{
        ...
        throws IOException, CertificateParsingException
    {
        ...
        return new X509CertificateObject(
                            ru.mipt.cybersecurity.asn1.x509.Certificate.getInstance(seq));
    }
        ...
        throws CertificateParsingException
    {
        if (sData != null)
        {
            while (sDataObjectCount < sData.size())
            {
                ...
                {
                   return new X509CertificateObject(
                                    ru.mipt.cybersecurity.asn1.x509.Certificate.getInstance(obj));
                }
            }
        }
