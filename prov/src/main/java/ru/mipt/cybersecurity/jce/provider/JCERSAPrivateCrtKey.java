    ...
    implements RSAPrivateCrtKey
{
    ...
    /**
     * construct a private key from it's ru.mipt.cybersecurity.crypto equivalent.
     *
    ...
    JCERSAPrivateCrtKey(
        ...
        throws IOException
    {
        this(ru.mipt.cybersecurity.asn1.pkcs.RSAPrivateKey.getInstance(info.parsePrivateKey()));
    }
