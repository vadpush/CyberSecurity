...
import ru.mipt.cybersecurity.jce.MultiCertStoreParameters;
    ...
    extends CertStoreSpi
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        {
            throw new InvalidAlgorithmParameterException("ru.mipt.cybersecurity.jce.provider.MultiCertStoreSpi: parameter must be a MultiCertStoreParameters object\n" +  params.toString());
        }
