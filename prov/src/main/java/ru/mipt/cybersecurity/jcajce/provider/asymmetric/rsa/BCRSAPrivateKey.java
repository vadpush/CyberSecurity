    ...
    implements RSAPrivateKey, PKCS12BagAttributeCarrier
{
    ...
    BCRSAPrivateKey(ru.mipt.cybersecurity.asn1.pkcs.RSAPrivateKey key)
    {
        this.modulus = key.getModulus();
        this.privateExponent = key.getPrivateExponent();
    }
    ...
    {
        return KeyUtil.getEncodedPrivateKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.rsaEncryption, DERNull.INSTANCE), new ru.mipt.cybersecurity.asn1.pkcs.RSAPrivateKey(getModulus(), ZERO, getPrivateExponent(), ZERO, ZERO, ZERO, ZERO, ZERO));
    }
