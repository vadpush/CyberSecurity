...
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.util.PKCS12BagAttributeCarrierImpl;
...
public class BCDSTU4145PrivateKey
    implements ECPrivateKey, ru.mipt.cybersecurity.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public BCDSTU4145PrivateKey(
        ru.mipt.cybersecurity.jce.spec.ECPrivateKeySpec spec)
    {
        this.d = spec.getD();
        ...
        throws IOException
    {
        ...
        {
            ru.mipt.cybersecurity.asn1.sec.ECPrivateKey ec = ru.mipt.cybersecurity.asn1.sec.ECPrivateKey.getInstance(privKey);
    ...
    public byte[] getEncoded()
    {
        ...
        PrivateKeyInfo info;
        ru.mipt.cybersecurity.asn1.sec.ECPrivateKey keyStructure;

        if (publicKey != null)
        {
            keyStructure = new ru.mipt.cybersecurity.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), publicKey, params);
        }
        else
        {
            keyStructure = new ru.mipt.cybersecurity.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), params);
        }
