...
import ru.mipt.cybersecurity.pqc.asn1.RainbowPrivateKey;
import ru.mipt.cybersecurity.pqc.crypto.rainbow.Layer;
import ru.mipt.cybersecurity.pqc.crypto.rainbow.RainbowPrivateKeyParameters;
import ru.mipt.cybersecurity.pqc.crypto.rainbow.util.RainbowUtil;
import ru.mipt.cybersecurity.pqc.jcajce.spec.RainbowPrivateKeySpec;
    ...
    implements PrivateKey
{
    ...
    public int hashCode()
    {
        ...
        hash = hash * 37 + ru.mipt.cybersecurity.util.Arrays.hashCode(A1inv);
        hash = hash * 37 + ru.mipt.cybersecurity.util.Arrays.hashCode(b1);
        hash = hash * 37 + ru.mipt.cybersecurity.util.Arrays.hashCode(A2inv);
        hash = hash * 37 + ru.mipt.cybersecurity.util.Arrays.hashCode(b2);
        hash = hash * 37 + ru.mipt.cybersecurity.util.Arrays.hashCode(vi);
