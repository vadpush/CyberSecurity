...
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.dstu.KeyFactorySpi;
...
{
    private static final String PREFIX = "ru.mipt.cybersecurity.jcajce.provider.asymmetric" + ".dstu.";
