...
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.rsa.KeyFactorySpi;
...
public class RSA
{
    private static final String PREFIX = "ru.mipt.cybersecurity.jcajce.provider.asymmetric" + ".rsa.";
