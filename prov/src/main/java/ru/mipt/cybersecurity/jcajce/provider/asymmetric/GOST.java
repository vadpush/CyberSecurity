...
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST
{
    private static final String PREFIX = "ru.mipt.cybersecurity.jcajce.provider.asymmetric" + ".gost.";
