...
import ru.mipt.cybersecurity.asn1.cms.GCMParameters;
...
import ru.mipt.cybersecurity.crypto.modes.CCMBlockCipher;
import ru.mipt.cybersecurity.crypto.modes.CFBBlockCipher;
import ru.mipt.cybersecurity.crypto.modes.CTSBlockCipher;
import ru.mipt.cybersecurity.crypto.modes.EAXBlockCipher;
import ru.mipt.cybersecurity.crypto.modes.GCFBBlockCipher;
...
import ru.mipt.cybersecurity.crypto.modes.OCBBlockCipher;
...
import ru.mipt.cybersecurity.crypto.params.RC5Parameters;
import ru.mipt.cybersecurity.jcajce.PBKDF1Key;
import ru.mipt.cybersecurity.jcajce.PBKDF1KeyWithParameters;
import ru.mipt.cybersecurity.jcajce.PKCS12Key;
import ru.mipt.cybersecurity.jcajce.PKCS12KeyWithParameters;
import ru.mipt.cybersecurity.jcajce.spec.AEADParameterSpec;
import ru.mipt.cybersecurity.jcajce.spec.GOST28147ParameterSpec;
import ru.mipt.cybersecurity.jcajce.spec.RepeatedSecretKeySpec;
    ...
    implements PBE
{
    ...
    protected BaseBlockCipher(
        ru.mipt.cybersecurity.crypto.BlockCipher engine,
        int ivLength)
    {
        baseEngine = engine;
    ...
    static private interface GenericBlockCipher
    {
        ...
        public ru.mipt.cybersecurity.crypto.BlockCipher getUnderlyingCipher();
        ...
        implements GenericBlockCipher
    {
        ...
        BufferedGenericBlockCipher(ru.mipt.cybersecurity.crypto.BlockCipher cipher)
        {
            this.cipher = new PaddedBufferedBlockCipher(cipher);
        }

        BufferedGenericBlockCipher(ru.mipt.cybersecurity.crypto.BlockCipher cipher, BlockCipherPadding padding)
        {
