...
import ru.mipt.cybersecurity.asn1.nsri.NSRIObjectIdentifiers;
...
import ru.mipt.cybersecurity.crypto.engines.ARIAEngine;
import ru.mipt.cybersecurity.crypto.engines.ARIAWrapEngine;
import ru.mipt.cybersecurity.crypto.engines.ARIAWrapPadEngine;
...
import ru.mipt.cybersecurity.jcajce.provider.symmetric.util.BaseAlgorithmParameterGenerator;
import ru.mipt.cybersecurity.jcajce.provider.symmetric.util.BaseAlgorithmParameters;
...
import ru.mipt.cybersecurity.jcajce.provider.symmetric.util.BaseWrapCipher;
...
public final class ARIA
{
        ...
        extends BaseMac
    {
        public Poly1305()
        {
            super(new ru.mipt.cybersecurity.crypto.macs.Poly1305(new ARIAEngine()));
        }
    }
