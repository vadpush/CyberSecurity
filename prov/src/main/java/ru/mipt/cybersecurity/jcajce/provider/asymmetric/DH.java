...
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.dh.KeyFactorySpi;
...
public class DH
{
    private static final String PREFIX = "ru.mipt.cybersecurity.jcajce.provider.asymmetric" + ".dh.";
