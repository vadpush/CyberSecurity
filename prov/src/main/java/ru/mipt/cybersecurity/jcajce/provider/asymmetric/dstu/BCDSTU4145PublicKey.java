package ru.mipt.cybersecurity.jcajce.provider.asymmetric.dstu;
...
import ru.mipt.cybersecurity.asn1.ua.DSTU4145BinaryField;
import ru.mipt.cybersecurity.asn1.ua.DSTU4145ECBinary;
import ru.mipt.cybersecurity.asn1.ua.DSTU4145NamedCurves;
import ru.mipt.cybersecurity.asn1.ua.DSTU4145Params;
import ru.mipt.cybersecurity.asn1.ua.DSTU4145PointEncoder;
import ru.mipt.cybersecurity.asn1.ua.UAObjectIdentifiers;
...
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.util.KeyUtil;
import ru.mipt.cybersecurity.jcajce.provider.config.ProviderConfiguration;
import ru.mipt.cybersecurity.jce.interfaces.ECPointEncoder;
...
public class BCDSTU4145PublicKey
    implements ECPublicKey, ru.mipt.cybersecurity.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    public BCDSTU4145PublicKey(
        ru.mipt.cybersecurity.jce.spec.ECPublicKeySpec spec,
        ProviderConfiguration configuration)
    {
        ...
        {
            ru.mipt.cybersecurity.jce.spec.ECParameterSpec s = configuration.getEcImplicitlyCa();
    ...
    public BCDSTU4145PublicKey(
        String algorithm,
        ECPublicKeyParameters params,
        ru.mipt.cybersecurity.jce.spec.ECParameterSpec spec)
    {
        ECDomainParameters      dp = params.getParameters();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        ru.mipt.cybersecurity.jce.spec.ECParameterSpec spec = null;
        ...
        else
        {
            ...
            spec = new ru.mipt.cybersecurity.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
        }
    ...
    public ru.mipt.cybersecurity.jce.spec.ECParameterSpec getParameters()
    {
    ...
    public ru.mipt.cybersecurity.math.ec.ECPoint getQ()
    {
        ru.mipt.cybersecurity.math.ec.ECPoint q = ecPublicKey.getQ();
    ...
    ru.mipt.cybersecurity.jce.spec.ECParameterSpec engineGetSpec()
    {
        if (ecSpec != null)
        {
            return EC5Util.convertSpec(ecSpec, withCompression);
