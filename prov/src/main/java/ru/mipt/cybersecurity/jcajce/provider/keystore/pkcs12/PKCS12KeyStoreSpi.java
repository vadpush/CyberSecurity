package ru.mipt.cybersecurity.jcajce.provider.keystore.pkcs12;
...
import ru.mipt.cybersecurity.asn1.ASN1Set;
import ru.mipt.cybersecurity.asn1.BEROctetString;
import ru.mipt.cybersecurity.asn1.BEROutputStream;
...
import ru.mipt.cybersecurity.asn1.DEROutputStream;
...
import ru.mipt.cybersecurity.asn1.pkcs.CertBag;
...
import ru.mipt.cybersecurity.jcajce.spec.PBKDF2KeySpec;
import ru.mipt.cybersecurity.jcajce.util.BCJcaJceHelper;
import ru.mipt.cybersecurity.jcajce.util.JcaJceHelper;
import ru.mipt.cybersecurity.jce.interfaces.BCKeyStore;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            ru.mipt.cybersecurity.asn1.pkcs.EncryptedPrivateKeyInfo eIn = ru.mipt.cybersecurity.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            ru.mipt.cybersecurity.asn1.pkcs.PrivateKeyInfo kInfo = ru.mipt.cybersecurity.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            ru.mipt.cybersecurity.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new ru.mipt.cybersecurity.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
