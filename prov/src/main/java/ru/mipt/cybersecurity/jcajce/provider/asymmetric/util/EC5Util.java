...
import ru.mipt.cybersecurity.math.field.FiniteField;
import ru.mipt.cybersecurity.math.field.Polynomial;
import ru.mipt.cybersecurity.math.field.PolynomialExtensionField;
...
public class EC5Util
{
    ...
    public static ru.mipt.cybersecurity.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        return new ru.mipt.cybersecurity.jce.spec.ECParameterSpec(
            curve,
    ...
    public static ru.mipt.cybersecurity.math.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
    ...
    public static ECPoint convertPoint(ru.mipt.cybersecurity.math.ec.ECPoint point)
    {
