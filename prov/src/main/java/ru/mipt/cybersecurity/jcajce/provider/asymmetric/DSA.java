...
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.dsa.DSAUtil;
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.dsa.KeyFactorySpi;
...
public class DSA
{
    private static final String PREFIX = "ru.mipt.cybersecurity.jcajce.provider.asymmetric" + ".dsa.";
