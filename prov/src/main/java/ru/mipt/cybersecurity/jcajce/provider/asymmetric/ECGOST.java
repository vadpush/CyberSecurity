...
import ru.mipt.cybersecurity.jcajce.provider.asymmetric.ecgost.KeyFactorySpi;
...
public class ECGOST
{
    private static final String PREFIX = "ru.mipt.cybersecurity.jcajce.provider.asymmetric" + ".ecgost.";
    private static final String PREFIX_GOST_2012 = "ru.mipt.cybersecurity.jcajce.provider.asymmetric" + ".ecgost12.";
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            registerOid(provider, RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256,
                    "ECGOST3410-2012",
                    new ru.mipt.cybersecurity.jcajce.provider.asymmetric.ecgost12.KeyFactorySpi());
