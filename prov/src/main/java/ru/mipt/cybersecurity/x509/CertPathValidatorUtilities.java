...
import ru.mipt.cybersecurity.asn1.isismtt.ISISMTTObjectIdentifiers;
...
import ru.mipt.cybersecurity.jce.provider.AnnotatedException;
import ru.mipt.cybersecurity.jce.provider.BouncyCastleProvider;
import ru.mipt.cybersecurity.jce.provider.PKIXPolicyNode;
...
class CertPathValidatorUtilities
{
    ...
    */
        ...
        throws AnnotatedException
    {
        ...
        ru.mipt.cybersecurity.jcajce.provider.asymmetric.x509.CertificateFactory certFact = new ru.mipt.cybersecurity.jcajce.provider.asymmetric.x509.CertificateFactory();
