package ru.mipt.cybersecurity.x509.util;
...
import ru.mipt.cybersecurity.jce.X509LDAPCertStoreParameters;
import ru.mipt.cybersecurity.jce.provider.X509AttrCertParser;
import ru.mipt.cybersecurity.jce.provider.X509CRLParser;
import ru.mipt.cybersecurity.jce.provider.X509CertPairParser;
import ru.mipt.cybersecurity.jce.provider.X509CertParser;
...
import ru.mipt.cybersecurity.x509.X509CRLStoreSelector;
import ru.mipt.cybersecurity.x509.X509CertPairStoreSelector;
import ru.mipt.cybersecurity.x509.X509CertStoreSelector;
import ru.mipt.cybersecurity.x509.X509CertificatePair;
...
public class LDAPStoreHelper
{
     ...
     * {@link ru.mipt.cybersecurity.x509.X509CertStoreSelector} of the given
     * selector.
     *
     * @param xselector             The selector with the search criteria.
