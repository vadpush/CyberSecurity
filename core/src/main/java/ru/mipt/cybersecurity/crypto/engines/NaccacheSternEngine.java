    ...
    implements AsymmetricBlockCipher
{
     ...
     * 
     * @see ru.mipt.cybersecurity.crypto.AsymmetricBlockCipher#init(boolean,
     *      ru.mipt.cybersecurity.crypto.CipherParameters)
     */
     ...
     * 
     * @see ru.mipt.cybersecurity.crypto.AsymmetricBlockCipher#getInputBlockSize()
     */
     ...
     * 
     * @see ru.mipt.cybersecurity.crypto.AsymmetricBlockCipher#getOutputBlockSize()
     */
     ...
     * 
     * @see ru.mipt.cybersecurity.crypto.AsymmetricBlockCipher#processBlock(byte[],
     *      int, int)
     */
