...
import ru.mipt.cybersecurity.crypto.util.PublicKeyFactory;
import ru.mipt.cybersecurity.util.Arrays;
import ru.mipt.cybersecurity.util.Integers;
import ru.mipt.cybersecurity.util.Shorts;
...
public class TlsUtils
{
    ...
    static void validateKeyUsage(ru.mipt.cybersecurity.asn1.x509.Certificate c, int keyUsageBits)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        ru.mipt.cybersecurity.asn1.x509.Certificate x509Cert = clientCertificate.getCertificateAt(0);
