 ...
 * </pre>
 *
 * @see ru.mipt.cybersecurity.asn1.x509.Certificate
 */
public class Certificate
{
    public static final Certificate EMPTY_CHAIN = new Certificate(
        new ru.mipt.cybersecurity.asn1.x509.Certificate[0]);

    protected ru.mipt.cybersecurity.asn1.x509.Certificate[] certificateList;

    public Certificate(ru.mipt.cybersecurity.asn1.x509.Certificate[] certificateList)
    {
    ...
    /**
     * @return an array of {@link ru.mipt.cybersecurity.asn1.x509.Certificate} representing a certificate
     *         chain.
     */
    public ru.mipt.cybersecurity.asn1.x509.Certificate[] getCertificateList()
    {
        return cloneCertificateList();
    }

    public ru.mipt.cybersecurity.asn1.x509.Certificate getCertificateAt(int index)
    {
        ...
        throws IOException
    {
        ...
        while (buf.available() > 0)
        {
            ...
            certificate_list.addElement(ru.mipt.cybersecurity.asn1.x509.Certificate.getInstance(asn1Cert));
        }

        ru.mipt.cybersecurity.asn1.x509.Certificate[] certificateList = new ru.mipt.cybersecurity.asn1.x509.Certificate[certificate_list.size()];
        for (int i = 0; i < certificate_list.size(); i++)
        {
            certificateList[i] = (ru.mipt.cybersecurity.asn1.x509.Certificate)certificate_list.elementAt(i);
        }
        return new Certificate(certificateList);
    }

    protected ru.mipt.cybersecurity.asn1.x509.Certificate[] cloneCertificateList()
    {
        ru.mipt.cybersecurity.asn1.x509.Certificate[] result = new ru.mipt.cybersecurity.asn1.x509.Certificate[certificateList.length];
