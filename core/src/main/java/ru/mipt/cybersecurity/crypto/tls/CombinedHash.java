    ...
    implements TlsHandshakeHash
{
    ...
    /**
     * @see ru.mipt.cybersecurity.crypto.Digest#getAlgorithmName()
     */
    ...
    /**
     * @see ru.mipt.cybersecurity.crypto.Digest#getDigestSize()
     */
    ...
    /**
     * @see ru.mipt.cybersecurity.crypto.Digest#update(byte)
     */
    ...
    /**
     * @see ru.mipt.cybersecurity.crypto.Digest#update(byte[], int, int)
     */
    ...
    /**
     * @see ru.mipt.cybersecurity.crypto.Digest#doFinal(byte[], int)
     */
    ...
    /**
     * @see ru.mipt.cybersecurity.crypto.Digest#reset()
     */
    public void reset()
    {
        md5.reset();
