...
public class NullEngine implements BlockCipher
{
    ...
    /* (non-Javadoc)
     * @see ru.mipt.cybersecurity.crypto.BlockCipher#init(boolean, ru.mipt.cybersecurity.crypto.CipherParameters)
     */
    ...
    /* (non-Javadoc)
     * @see ru.mipt.cybersecurity.crypto.BlockCipher#getAlgorithmName()
     */
    ...
    /* (non-Javadoc)
     * @see ru.mipt.cybersecurity.crypto.BlockCipher#getBlockSize()
     */
    ...
    /* (non-Javadoc)
     * @see ru.mipt.cybersecurity.crypto.BlockCipher#processBlock(byte[], int, byte[], int)
     */
    ...
    /* (non-Javadoc)
     * @see ru.mipt.cybersecurity.crypto.BlockCipher#reset()
     */
    public void reset()
    {
