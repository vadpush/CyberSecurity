package ru.mipt.cybersecurity.crypto.modes;
    ...
    extends BufferedBlockCipher
{
     ...
     * @exception ru.mipt.cybersecurity.crypto.DataLengthException if there isn't enough space in out.
     ...
     * @return the number of output bytes copied to out.
     * @exception ru.mipt.cybersecurity.crypto.DataLengthException if there is insufficient space in out for
     * the output.
     * @exception IllegalStateException if the underlying cipher is not
     * initialised.
     * @exception ru.mipt.cybersecurity.crypto.InvalidCipherTextException if cipher text decrypts wrongly (in
